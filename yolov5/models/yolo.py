...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # elif m in {poolformer_s12, poolformer_s24, poolformer_m36, poolformer_m48, poolformer_s36}:
        elif m in {efficientformerv2_s0}:
        # elif m in {efficientvit_b1, efficientvit_b0, efficientvit_b2, efficientvit_b3}:
            m = m(*args)
            c2 = m.channel
        else:
            c2 = ch[f]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cfg", type=str, default="/home/featurize/work/yolov5_fruits/yolov5/models/yolov5_efficientformer_s0.yaml", help="model.yaml")
